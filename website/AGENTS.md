...
This is a generated ditto.site clone app for https://www.ahneta.nl/. It is a static Next.js App Router project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
- / - Home | Ahneta Advies
- /aangifte-ib - Aangifte IB | Ahneta Advies
- /administratie - Administratie | Ahneta Advies
- /bedrijven - Bedrijven | Ahneta Advies
- /blog - Blog Posts | Ahneta Advies
- /contactus - Contact Us | Ahneta Advies
- /cookie-policy - Cookie Policy | Ahneta Advies
- /estate-planning - Estate Planning | Ahneta Advies
- /ondernemersplan - Ondernemersplan | Ahneta Advies
- /onze-diensten - Diensten | Ahneta Advies
- /over-ons - Over ons | Ahneta Advies
- /particulieren - Particulieren | Ahneta Advies
- /pricing - Pricing | Ahneta Advies
- /privacy - Privacy Policy | Ahneta Advies
- /startende-ondernemer - Startende Ondernemer | Ahneta Advies
- /blog/reis-1 - Reis | Ahneta Advies
- /blog/success-stories-2 - Success Stories | Ahneta Advies

Deliberately excluded (Odoo backend/utility routes, not public marketing pages): /web/login,
/web/reset_password, /website/info, /website/social/{twitter,linkedin,instagram}, and the two
blog RSS feed endpoints. In-page links to the login and social-icon URLs now point at the real
https://www.ahneta.nl/... targets instead of a local route.
